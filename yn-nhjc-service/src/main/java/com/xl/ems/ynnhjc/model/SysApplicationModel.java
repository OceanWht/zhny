...
public class SysApplicationModel {
    private Integer id;
    ...
    public void setRegisterprincipal(String registerprincipal) {
        this.registerprincipal = registerprincipal == null ? null : registerprincipal.trim();
    }
    ...
    public void setEnergyconsumelevel(String energyconsumelevel) {
        this.energyconsumelevel = energyconsumelevel == null ? null : energyconsumelevel.trim();
    }
    ...
    public void setJgzh(String jgzh) {
        this.jgzh = jgzh == null ? null : jgzh.trim();
    }
    ...
    public void setLeadingproduct(String leadingproduct) {
        this.leadingproduct = leadingproduct == null ? null : leadingproduct.trim();
    }
