...
public class SMS4Main {
    ...
    public static void main(String[] args) throws IOException {
        String text = "06123456FFFFFFFF";
        System.out.println("原文：" + text);
        String entext = new SMS4Main().encryptData_CBC(text);
        entext = entext.substring(0,32);
        //String  entext = new SMS4Main().encryptData_ECB(text);
        System.out.println("加密：" + entext);
        System.out.append("解密：" + new SMS4Main().decryptData_CBC(entext));
